...
function getSubjects(SoGBHP, masv)
{
	$.ajax({
		...
		success: function(result) {
			...
			let title = "DANH SÁCH MÔN HỌC CỦA PHIẾU NỘP " + result['SoGBHP'];
			...
			$("#bodyModal-2").html(table + header + body +  "</table>"); //custom cái body của Modal1

			$("#titleModal-2").html(title); //Đôi title của Modal1
