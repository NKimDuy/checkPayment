		...
		$.ajax({
			...
			success: function(result) {
				...
				body1 += 	'<tr>'+
								...
								'<td><h5>[' + result['accounting'][0]  + '] ' + result['accounting'][1] + '</h5></td>' +
				...
				body1 += 	'<tr>'+
								...
								'<td><h5>' + formatCurrency(result['accounting'][4]) + ' %</h5></td>' +
				...
				for(value of result['dssv']) {
					...
					body += "<td>"  + value[0] + "</td>"; // NHHK
					body += "<td>"  + value[1] + "</td>"; // MSSV
					body += "<td>"  + value[2] + ' ' + value[3] + "</td>"; // Họ và tên
					body += "<td>"  + value[4] + "</td>"; // Mã lớp
					body += "<td>"  + value[5] + "</td>"; // Tên lớp
					body += "<td>"  + value[6] + "</td>"; // Mã PNT
					body += "<td>"  + formatCurrency(value[7]) + ' VND' + "</td>"; // Sô tiền
					body += "<td>"  + value[8] + "</td>"; // ngày đóng
					body += "<td>"  + value[9] + "</td>"; // ghi chú
				}
