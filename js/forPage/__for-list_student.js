		...
		$.ajax({
			...
			success: function(result) {
				...
				let div =	"<div class='box-header with-border'>" +
							"<div class='col-md-3'>" +
								"<button type='button' onclick='history.back()' class='btn btn-block btn-info'>" + 
									"<i class='fa fa-long-arrow-left'></i> XEM LỚP KHÁC" +
								"</button>" + 
							"</div></div>" +
							"<div class='box-body'>";
				...
				let header = "<thead>";
					...
					header += "<th>Chi tiết sinh viên</th>";
					header += "</tr>";
					header += "</thead>";
