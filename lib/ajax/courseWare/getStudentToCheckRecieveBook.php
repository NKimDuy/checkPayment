<?php
	...
	/*
		file có nhiệm vụ hiện danh sách sinh viên đã lưu vào csdl và chưa có nhận sách, 
		
		bước 1: sẽ lấy tất cả sinh viên chưa nhận sách
		
		bước 2: thêm các ô tick phía trước để xác nhận là sinh viên đã nhận sách
	*/
